...
function toggleButton() {
    const button = document.getElementById('anonymousButton');
    ...
    if (isClicked) {
        ...
        button.innerHTML = '<i class="fa fa-user-secret"></i> <span class="d-none d-md-inline">Posting Anonymously</span>';
        button.setAttribute('data-clicked', 'true');
        anonymousInput.value = 'true';  // Update the anonymous field to true
    }

    // Log the anonymous field for debugging
